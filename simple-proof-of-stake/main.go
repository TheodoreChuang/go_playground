...
// standard variable that allows us to control reads/writes and prevent data races
...
func handleConn(conn net.Conn) {
	...
	// receives and prints out any announcements that come from the TCP server
	go func() {
		for {
			msg := <-announcements
...
func pickWinner() {
	...
	OUTER:
		for _, block := range temp {
			...
			// check validator is actually an eligible validator that sits in our validators map
